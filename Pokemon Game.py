...
import random
import time
pname1 = input("What is the first Trainer's name?")
pname2 = input("And what is the second Trainer's name?")
...
Move_List = {name: {Type:Type, Dmg_Type:Dmg_Type, Power:Power, Effect:Effect, pp:pp}}
